...
public class Task1 {
	...
	public static List<String>getAllFunctions(String path) throws IOException{
		...
		do{                                        
			...
			for(int i = 0; i < a.length()-6;i++){
                            if(a.substring(i, i+6).equals(name)){			
	...
	public static String findFunctionByName(String name) throws IOException {		
		String path = "D:\\Netbean\\JavaApplication7\\src\\javaapplication7\\Task1.java";
	...
	public static void main(String[] args) throws IOException {
		...
		for(int i = 0 ; i < a.size(); i++){
                ...
                System.out.println(findFunctionByName("findFunctionByName(String)"));
	}
}
